...
export default function Header() {
  ...
  const isNavAllowed = (href: string) => {
    ...
    const menuKeyMap: Record<string, string> = {
      ...
      '/live-sales': 'live_sales',
      '/live-sales-analytics': 'live_sales_analytics',
      '/loose-sales': 'loose_sales',
      '/loose-sales-analytics': 'loose_sales_analytics',
      '/utilities': 'utilities',
  ...
  const mainNavItems = [
    ...
    { label: 'Live Sales', href: '/live-sales', icon: <TrendingUp size={17} /> },
    { label: 'Live Analytics', href: '/live-sales-analytics', icon: <BarChart3 size={17} /> },
  ...
  // Rich Card-Based App Menu Catalog matching Sidebar Menu
  const allCardApps = useMemo(() => [
    // 1. Main Navigation
    {
      label: 'Home',
      description: 'Analytics, revenue overview & store performance',
      href: '/',
      icon: <Home size={22} />,
    ...
    {
      label: 'Live Sales',
      description: 'Dedicated live POS counter billing, barcode scanning & thermal print receipts',
      href: '/live-sales',
    ...
    },
    {
      ...
      description: 'Real-time sales feed, Cash/UPI/Card splits, item statistics & bill reprints',
    ...
    {
      label: 'Loose Sales',
      description: 'Quick loose sweets, snacks and counter cash/UPI entries by staff',
      href: '/loose-sales',
      icon: <Coins size={22} />,
      category: 'Main Navigation',
    ...
    {
      label: 'Loose Sales Analytics',
      description: 'Staff-wise total loose sales breakdown, Cash, UPI, Card and performance',
    ...
    {
      label: 'Products',
      description: 'Item prices, slot weights & favourite sweets master',
      href: '/items',
      icon: <Tag size={22} />,
      category: 'Main Navigation',
    ...
    {
      label: 'Inventory',
      description: 'Raw materials, ingredients, ghee, sugar & packaging stock',
      href: '/inventory',
      icon: <Boxes size={22} />,
      category: 'Main Navigation',
    ...
    {
      label: 'Manufacturing',
      description: 'Daily slot batching, allocations & kitchen work orders',
      href: '/manufacturing',
    ...
    {
      label: 'Utilities',
      description: 'Utility items, box rates, sticker & shrink pricing',
      href: '/utilities',
    ...
    {
      label: 'Wholesalers',
      description: 'B2B client ledgers, credit terms & wholesaler profiles',
      href: '/wholesalers',
      icon: <Users size={22} />,
      category: 'Management',
    ...
    {
      label: 'Customers',
      description: 'Customer profiles, contact numbers & store order ledger',
      href: '/customers',
