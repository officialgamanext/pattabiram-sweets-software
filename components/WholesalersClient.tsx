    ...
    <div className="w-full flex flex-col gap-4 text-slate-800">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-slate-900 tracking-tight">Wholesalers</h1>
        </div>

        <div className="flex items-center gap-2 flex-wrap">
          <button
            onClick={() => toast.info('Exporting Wholesalers', 'Preparing wholesalers export file...')}
